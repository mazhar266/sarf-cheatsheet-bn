...
\noindent\begin{tabularx}{\textwidth}{|C|C|C|C|}
  \hline
  \rowcolor{lightgreen}
  আলোকিত করা & {\arabicfont \tafeelmasdar{ن}{و}{ر}} &
  পরিষ্কার করা & {\arabicfont \tafeelmasdar{ن}{ظ}{ف}} \\
  \hline

  কথা বলা & {\arabicfont \tafeelmasdar{ك}{ل}{م}} &
  সালাম দেয়া & {\arabicfont \tafeelmasdar{س}{ل}{م}} \\
  \hline

  \rowcolor{lightgreen}
  মিথ্যা মনে করা & {\arabicfont \tafeelmasdar{ك}{ذ}{ب}} &
  সত্য মনে করা & {\arabicfont \tafeelmasdar{ص}{د}{ق}} \\
  \hline
\end{tabularx}
